class Hero:
    ...
    @staticmethod
    def calculate_effective_power(base_power: int, attributes: str) -> int:
        attribute_bonus = sum(attributes.values()) / len(attributes)
        calculate_effective_power = base_power * (1 + attribute_bonus)
        round(calculate_effective_power, 1)
        return calculate_effective_power
